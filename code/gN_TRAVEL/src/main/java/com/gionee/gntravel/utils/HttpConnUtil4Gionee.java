...
public class HttpConnUtil4Gionee extends AsyncTask<Object, Object, String> {
	private HttpConnCallback callBack;

	public HttpConnUtil4Gionee(HttpConnCallback callBack) {
